...
class D3ExponentialLine extends React.Component {
    constructor(props) {
        super(props)
        this.exponentialLine = {
            width: null,
            height: null,
    ...
    componentDidMount() {
        ...
        this.exponentialLine.width = containerWidth - margin.left - margin.right
        this.exponentialLine.height = this.exponentialLine.width
        const {width, height, fy} = this.exponentialLine
        let chart = d3
    ...
    render() {
        return (
            <div className="exponential-line-simple">
